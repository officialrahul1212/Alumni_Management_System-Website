  ...
  <div class="container d-flex justify-content-center">
    <div class="card card-shadow w-50 m-4">
      <div class="modal-header bg-primary text-white">
        ...
        <a href="gallery.php"><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></a>
      </div>
      <div class="card-body">
        <form class="row g-3" action="gallery_managedata.php" method="POST" enctype="multipart/form-data">
          <?php
          if (isset($_POST['edit'])) {
            $id = $_POST['id'];
          ...
          <div class="modal-footer justify-content-center">
            ...
            <a href="gallery.php" class="btn btn-dark">Close</a>
          </div>
        </form>
      </div>
    </div>
