...
<body style="color:black">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="row g-3" action="course_data.php" method="POST">
        ...
        <div class="container-fluid ">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <button class="btn btn-primary float-right btn-sm" data-bs-toggle="modal"
                    data-bs-target="#staticBackdrop"><i class="fa fa-plus"></i> New-Course</button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                        <form action="course_manage.php" method="POST">
    ...
    <div class="col-lg-16 d-flex align-items-center justify-content-end m-3 pt-5">
            <a href="course_report.php" class="btn btn-warning text-dark w-15"><b>Course_Report</b></a>
        </div>
