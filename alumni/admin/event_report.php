...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $qry = "SELECT * FROM event WHERE schedule BETWEEN ? AND ?";
...
<body style="color:black">
    <div class="container-fluid mt-5">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="events.php" class="btn btn-secondary btn-sm"><i class="fa fa-arrow-circle-left"></i>  Back </a>
        </div>
                            ...
                            <tbody>
                                <?php foreach ($donations as $index => $donation): ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($donation['event']); ?></td>
                                        <td><?php echo htmlspecialchars($donation['schedule']); ?></td>
