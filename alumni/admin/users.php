...
<body style="color:black">
        ...
        <div class="card  card-shadow col-lg-12">
            <div class="card-body">
                ...
                <table class='table table-bordered border-dark' id="dataTable" width="100%" style="color:black">
                    ...
                    <tbody>
                        <?php
                        $qry = "SELECT * FROM user where role='admin' or status='verified' ";
                                ...
                                <td>
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                        <form action="user_manage.php" method="POST">
                                            ...
                                            <input type="submit" name="edit" class="btn btn-primary mx-auto" value="Edit" />
                                        </form>
    ...
    <div class="col-lg-16 d-flex align-items-center justify-content-end m-3 pt-5">
            <a href="user_report.php" class="btn btn-warning text-dark w-15"><b>User Report</b></a>
        </div>
